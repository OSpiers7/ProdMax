...
Write-Host "Testing ProdMax Calendar Implementation..." -ForegroundColor Green
Write-Host ""

# Check if we're in the right directory
if (!(Test-Path "frontend\src\components\Calendar\Calendar.tsx")) {
    Write-Host "Error: Calendar component not found. Make sure you're in the ProdMax directory." -ForegroundColor Red
    exit 1
}

Write-Host "Calendar component found" -ForegroundColor Green
Write-Host "TaskForm component found" -ForegroundColor Green
Write-Host "Shared types configured" -ForegroundColor Green
Write-Host ""
